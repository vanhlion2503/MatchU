  ...
  static List<ReactionIcon> reactions = [
    ReactionIcon(
      ...
      icon: Container(
        ...
        child: const Icon(Icons.thumb_up, size: 18, color: Colors.white),
      ),
    ),
    ...
    ReactionIcon(id: "haha", icon: Text("😂", style: TextStyle(fontSize: 26))),

    ReactionIcon(id: "wow", icon: Text("😮", style: TextStyle(fontSize: 26))),
    ReactionIcon(id: "lo", icon: Text("😢", style: TextStyle(fontSize: 26))),
    ReactionIcon(id: "gian", icon: Text("😡", style: TextStyle(fontSize: 26))),
  ];
