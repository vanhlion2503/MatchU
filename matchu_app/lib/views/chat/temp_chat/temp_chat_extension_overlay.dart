...
/// Urgent room-extension affordance shown above the chat content.
///
...
class TempChatExtensionOverlay extends StatefulWidget {
  const TempChatExtensionOverlay({super.key, required this.controller});

  final TempChatController controller;

  @override
  State<TempChatExtensionOverlay> createState() =>
      _TempChatExtensionOverlayState();
}

class _TempChatExtensionOverlayState extends State<TempChatExtensionOverlay> {
...
class _ExtensionBubble extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      width: _TempChatExtensionOverlayState._bubbleSize,
      height: _TempChatExtensionOverlayState._bubbleSize,
      decoration: BoxDecoration(
        shape: BoxShape.circle,
        gradient: _extensionGradient,
        border: Border.all(
